...
#' @usage power_Geometric(n1 = NULL, n2 = NULL, mu1 = NULL, mu2 = NULL, 
...
#' @export
power_Geometric <- function(n1 = NULL, n2 = NULL, mu1 = NULL, mu2 = NULL, 
                            sig.level = 0.05, power = NULL, duration = 1,
                            equal.sample = TRUE, alternative = c("two.sided", "one.sided"),
                            approach = 3) {
  ...
  if (equal.sample) {
    METHOD <- "Two-sample Geometric rates Tests (Equal Sizes)"
    n2 <- n1
    ...
    METHOD <- "Two-sample Geometric rates Tests (Different Sizes)"
