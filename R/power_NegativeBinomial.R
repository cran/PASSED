...
#' @usage power_NegativeBinomial(n1 = NULL, n2 = NULL, mu1 = NULL, mu2 = NULL, 
...
#' @param approach 1, 2, or 3, see details
...
#' @export
power_NegativeBinomial <- function(n1 = NULL, n2 = NULL, mu1 = NULL, mu2 = NULL, 
                                   sig.level = 0.05, power = NULL, duration = 1, theta = NULL,
                                   equal.sample = TRUE, alternative = c("two.sided", "one.sided"),
                                   approach = 3) {
