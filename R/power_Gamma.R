...
#' @usage power_Gamma(n1 = NULL, n2 = NULL, mu1 = NULL, mu2 = NULL, 
...
#' @export
power_Gamma <- function(n1 = NULL, n2 = NULL, mu1 = NULL, mu2 = NULL, 
                        gmu1 = NULL, gmu2 = NULL, sig.level = 0.05, power = NULL, 
                        trials = 100, M = 10000, equal.sample = TRUE, equal.shape = NULL) {
  # Check the equal sample settings
  ...
  # Case 2: unequal shape parameter delta1 != delta2
    ...
    RejectTest <- sapply(1:trials, function(i) {
      ...
      lambda_model <- function(lambda) {
        c(
          F1 = 1 + log(lambda[1]) - digamma(lambda[3] * lambda[1]) + log(gmu1) - mu1 / lambda[3],
