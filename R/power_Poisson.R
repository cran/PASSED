...
#' @usage power_Poisson(n1 = NULL, n2 = NULL, lambda1 = NULL, lambda2 = NULL, 
#' sig.level = 0.05, power = NULL, t1 = 1, t2 = 1, RR0 = 1,
...
#' power_Poisson(
#'   n1 = 2000, lambda1 = 0.0005, lambda2 = 0.003, power = 0.8,
...
#' @export
power_Poisson <- function(n1 = NULL, n2 = NULL, lambda1 = NULL, lambda2 = NULL, 
                          sig.level = 0.05, power = NULL, t1 = 1, t2 = 1, RR0 = 1,
                          equal.sample = TRUE, alternative = c("two.sided", "one.sided")) {
  # check the inputs
  if (equal.sample == TRUE) {
    ...
    return(structure(list(
      N = n1, lambda1 = lambda1, lambda2 = lambda2, sig.level = sig.level, power = power,
    ...
    return(structure(list(
      n1 = n1, n2 = n2, lambda1 = lambda1, lambda2 = lambda2, sig.level = sig.level, power = power,
